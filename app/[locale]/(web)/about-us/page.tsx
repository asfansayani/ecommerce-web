...
export const metadata: Metadata = {
  title: "About Us – Bijou Sky",
  description:
    "Discover the story behind Bijou Sky and the care we put into every product we offer.",
};

export default async function AboutUsPage() {
  const locale = await getLocale();
  const response = await getPage(PAGE_IDS.ABOUT_US);
  ...
  return (
    <div className="min-h-screen bg-white">
      <section className="bg-[#F9F6F2] py-16 md:py-24 text-center px-4">
        ...
        <h1 className="secHd">About Us</h1>
      </section>
